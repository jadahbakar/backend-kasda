...
var rkfRouter = require('./routes/rkfRoutes')
var aktivitasRouter = require('./routes/aktivitasRoutes')
var testRouter = require('./routes/testRoutes')

var sasaranRouter = require('./routes/sasaranRoutes')
var inisiatifRouter = require('./routes/inisiatifRoutes')
var dashboardRouter = require('./routes/dashboardRoutes')
var jaringanRouter = require('./routes/jaringanRoutes')
var adminRouter = require('./routes/adminRoutes')
var notifRouter = require('./routes/notifRoutes')
var rkbuRouter = require('./routes/rkbuRoutes')
var bangrenRouter = require('./routes/bangrenRoutes')
var pabRouter = require('./routes/pabRoutes')
...
app.use('/rkf', rkfRouter)
app.use('/aktivitas', aktivitasRouter)
app.use('/test', testRouter)

app.use('/sasaran', sasaranRouter)
app.use('/inisiatif', inisiatifRouter)
app.use('/dashboard', dashboardRouter)
app.use('/jaringan', jaringanRouter)
app.use('/admin', adminRouter)
app.use('/notif', notifRouter)
app.use('/rkbu', rkbuRouter)
app.use('/bangren', bangrenRouter)
app.use('/pab', pabRouter)
